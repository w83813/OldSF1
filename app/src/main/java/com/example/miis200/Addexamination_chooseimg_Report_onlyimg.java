...
public class Addexamination_chooseimg_Report_onlyimg extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_addexamination_chooseimg_report_onlyimg);
        ...
        cancelchoose.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder a_builder = new AlertDialog.Builder(Addexamination_chooseimg_Report_onlyimg.this);
        ...
        newprinter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!Button_Click.isFastDoubleClick()) {
                    if(x > 4){
                        Toast.makeText(Addexamination_chooseimg_Report_onlyimg.this, R.string.Choose_image_max_4_image, Toast.LENGTH_LONG).show();
                    }else if(x == 0){
                        Toast.makeText(Addexamination_chooseimg_Report_onlyimg.this, R.string.Choose_image_not_choose, Toast.LENGTH_LONG).show();
                    } else {
                        Intent intent = new Intent(); //登入成功轉跳至首頁
                        intent.setClass(Addexamination_chooseimg_Report_onlyimg.this, Addexamination_report_onlyimg.class);
                        System.out.println("mdskdmskdmskdmskdmaskmdokdmsodsmviodv");

                        intent.putExtra("a",pName);
                        intent.putExtra("b",pID);
                        intent.putExtra("c",pBir);
                        intent.putExtra("d",pGender);
                        intent.putExtra("e",pName);
