...
public class Printerwait_chooseimg_Report extends AppCompatActivity {
        ...
        newprinter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!Button_Click.isFastDoubleClick()) {
                    if(x > 4){
                        Toast.makeText(Printerwait_chooseimg_Report.this, R.string.Choose_image_max_4_image, Toast.LENGTH_LONG).show();
                    } else if(x == 0){
                        Toast.makeText(Printerwait_chooseimg_Report.this, R.string.Choose_image_not_choose, Toast.LENGTH_LONG).show();
                    } else {
                        Intent intent = new Intent(); //登入成功轉跳至首頁
                        intent.setClass(Printerwait_chooseimg_Report.this, Printerwait_Report.class);
