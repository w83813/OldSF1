...
public class Viewwait_chooseimg_viewfinish extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cancelchoose.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder a_builder = new AlertDialog.Builder(Viewwait_chooseimg_viewfinish.this);
                a_builder.setMessage(R.string.Cancel_message)
                        ...
                        .setPositiveButton("Yes",new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                startActivity(new Intent(Viewwait_chooseimg_viewfinish.this, Option.class));
                                finish();
                            }
                        })
        ...
        newprinter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(x > 4){
                    Toast.makeText(Viewwait_chooseimg_viewfinish.this, R.string.Choose_image_max_4_image, Toast.LENGTH_LONG).show();
                } else if(x == 0){
                    Toast.makeText(Viewwait_chooseimg_viewfinish.this, R.string.Choose_image_not_choose, Toast.LENGTH_LONG).show();
                } else {
                    Intent intent = new Intent(); //登入成功轉跳至首頁
                    intent.setClass(Viewwait_chooseimg_viewfinish.this, Viewwait_report_viewfinish.class);
